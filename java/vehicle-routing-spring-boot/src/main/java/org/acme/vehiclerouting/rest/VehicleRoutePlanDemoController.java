...
public class VehicleRoutePlanDemoController {
    ...
    public ResponseEntity<VehicleRoutePlan> generate(@Parameter(description = "Unique identifier of the demo data.",
            required = true) @PathVariable("demoDataId") DemoData demoData) {
        return ResponseEntity.ok(build(demoData));
    }
