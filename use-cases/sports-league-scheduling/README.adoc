...
image::./quarkus-sports-leaghe-scheduling-screenshot.png[]
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-sports-league-scheduling-quickstart:1.0-SNAPSHOT
----
