...
image::./quarkus-flight-crew-scheduling-screenshot.png[]
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-flight-crew-scheduling-quickstart:1.0-SNAPSHOT
----
