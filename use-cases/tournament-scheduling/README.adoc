...
...
$ cd timefold-quickstarts/use-cases/tournament-scheduling
----
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/timefold-solver-quarkus-tournament-scheduling-quickstart:1.0-SNAPSHOT
----
