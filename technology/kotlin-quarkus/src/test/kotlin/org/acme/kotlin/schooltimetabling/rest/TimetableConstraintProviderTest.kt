...
import org.acme.kotlin.schooltimetabling.solver.TimeTableConstraintProvider
...
class TimetableConstraintProviderTest {
    ...
    fun roomConflict() {
        ...
        val conflictingLesson =
            Lesson(2, "Subject2", "Teacher2", "Group2", TIMESLOT1, ROOM1)
        val nonConflictingLesson =
            Lesson(3, "Subject3", "Teacher3", "Group3", TIMESLOT2, ROOM1)
    ...
    fun teacherConflict() {
        ...
        val firstLesson =
            Lesson(1, "Subject1", conflictingTeacher, "Group1", TIMESLOT1, ROOM1)
        val conflictingLesson =
            Lesson(2, "Subject2", conflictingTeacher, "Group2", TIMESLOT1, ROOM2)
        val nonConflictingLesson =
            Lesson(3, "Subject3", "Teacher2", "Group3", TIMESLOT2, ROOM1)
    ...
    fun studentGroupConflict() {
        ...
        val firstLesson =
            Lesson(1, "Subject1", "Teacher1", conflictingGroup, TIMESLOT1, ROOM1)
        val conflictingLesson =
    ...
    fun teacherRoomStability() {
        ...
        val lessonInFirstRoom =
            Lesson(1, "Subject1", teacher, "Group1", TIMESLOT1, ROOM1)
        val lessonInSameRoom = Lesson(2, "Subject2", teacher, "Group2", TIMESLOT1, ROOM1)
        val lessonInDifferentRoom =
            Lesson(3, "Subject3", teacher, "Group3", TIMESLOT1, ROOM2)
    ...
    fun teacherTimeEfficiency() {
        val teacher = "Teacher1"
        val singleLessonOnMonday =
            Lesson(1, "Subject1", teacher, "Group1", TIMESLOT1, ROOM1)
        val firstTuesdayLesson =
            Lesson(2, "Subject2", teacher, "Group2", TIMESLOT2, ROOM1)
        val secondTuesdayLesson =
            Lesson(3, "Subject3", teacher, "Group3", TIMESLOT3, ROOM1)
        val thirdTuesdayLessonWithGap =
            Lesson(4, "Subject4", teacher, "Group4", TIMESLOT4, ROOM1)
    ...
    fun studentGroupSubjectVariety() {
        ...
        val mondayLesson =
            Lesson(1, repeatedSubject, "Teacher1", studentGroup, TIMESLOT1, ROOM1)
        val firstTuesdayLesson =
